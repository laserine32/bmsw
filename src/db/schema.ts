...
export const tags = pgTable(
	...
	(table) => [uniqueIndex("Tags_tag_key").using("btree", table.tag.asc().nullsLast().op("text_ops"))],
);
...
export const bookmark = pgTable(
	...
	(table) => [uniqueIndex("Bookmark_url_key").using("btree", table.url.asc().nullsLast().op("text_ops"))],
);
